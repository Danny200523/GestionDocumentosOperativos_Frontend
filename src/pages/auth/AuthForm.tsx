...
const AuthForm = ({ title, buttonLabel, fields, onSubmit, validate }: AuthFormProps) => {
  ...
  return (
    <div className="bg-white/5 backdrop-blur-md border border-white/20 shadow-2xl p-8 rounded-2xl border border-slate-800 p-8 rounded-2xl shadow-lg w-full max-w-md">
          ...
          <div key={field.name} className="relative">
            {field.type === "select" ? (
              <select
                ...
                className="w-full border border-gray-200 bg-[#232255]  outline-none text-gray-200 py-2 px-3 rounded-lg"
              >
              ...
              <>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 bg-[#232255] outline-none placeholder:text-gray-100 text-gray-200 py-2 px-7 rounded-lg"
                  value={formData[field.name] || ""}
